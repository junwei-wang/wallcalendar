...
\newfontfamily\josefinSans{SimHei}
...
\SetPhoto[bleed=3mm, file={green-mountains-crop-us-letter}]{January}
...
\SetEvents{November}{%
\semicolonEndTikzCalendar%
% \calDayNumberNode{cal11-2019-11-01}{-redo}{\dayTextFmt 01}%
\parseMonthMarksDayTextInlineUsing{./data/moonphases-2019.csv}%
\parseMonthInlineNotes%
}{}
...
\TitlePage{green-mountains-crop-us-letter}{60mm}{%
  ...
  \CalendarYear\par
  Calendar for Junwei Wang \& Lin Li
}
